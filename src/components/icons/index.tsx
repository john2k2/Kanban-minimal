...
export function KanbanIcon({ className, size = 20 }: IconProps) {
    return (
        <svg
            className={className}
            width={size}
...
export function GripIcon({ className, size = 6 }: IconProps) {
    return (
        <svg
            className={className}
            width={size}
...
export function EmptyStateIcon({ className, size = 32 }: IconProps) {
    return (
        <svg
            className={className}
            width={size}
